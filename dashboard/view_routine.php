...
<div class="wrapper ">
    <!-- sidebar link add -->
    <?php $page='routine'; include('inc/sidebar.php') ?>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="form-group">
                                        <label class="text-dark">view routine</label>
                                        <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="department" class="form-control px-1" disabled>
                                            <option><?php echo $data_info['category'] ?></option>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                    <label for="">Routine Photo</label>
                                        <img class="rounded" src="../upload_photo/routine/<?php echo $data_info['photo'] ?>" width="100%">
                                        <label class="btn btn-sm">published date <?php echo $data_info['date'] ?></label>
                                    </div>
                                    <a href="../oparetions/delete_routine.php?del=<?php echo $_GET['nt_view']?>" type="submit" class="btn btn-danger pull-right btn-sm" onclick="return confirm('Are You Sure?')">delete</a>
                            </div>
