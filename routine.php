...
<head>
    ...
    <title>Class Routine | Jhenaidah Technical School and college</title>
...
<body>
    ...
    <div class="container">
        <div class="rapper">
            <h4 class="text-uppercase border-4 py-3 text-center mx-auto d-name">class routine</h4>
            <div class="student my-5">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <?php
                        $data = mysqli_query($con, "SELECT * FROM routine WHERE category='class routine'");
                        $i = 1;
